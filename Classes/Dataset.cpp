...
public:
	Dataset(string inputFile, bool BreakingHigshDatasets = false, bool allHistoricalDataset = false) {
		...
		if (BreakingHigshDatasets) {
			string Bullrun2017 = ".\\Clean Data\\Daily-2017-Feb-23-to-2017-Dec-17.csv";
			string Bullrun2021 = "./Clean Data/Daily-2020-Nov-30-to-21-Apr-14.csv";
		...
		if (allHistoricalDataset) {
			this->outputFiles.push_back("./Raw Data/BTC-USD-Daily-Yahoo.csv");
		}
	};
